...
exports.CHAIN_INFO = {
    [chains_1.SupportedChainId.RINKEBY]: {
        id: chains_1.SupportedChainId.RINKEBY,
        name: 'Rinkeby',
        nativeCurrency: {
            name: 'Rinkeby ETH',
            symbol: 'ETH',
    ...
    [chains_1.SupportedChainId.POLYGON_MAINNET]: {
        id: chains_1.SupportedChainId.POLYGON_MAINNET,
    ...
    [chains_1.SupportedChainId.OPTIMISM_MAINNET]: {
        id: chains_1.SupportedChainId.OPTIMISM_MAINNET,
    ...
    [chains_1.SupportedChainId.CELO_ALFAJORES_TESTNET]: {
        id: chains_1.SupportedChainId.CELO_ALFAJORES_TESTNET,
